...
@ipywidgets.register
class VTK(ipywidgets.DOMWidget, rs_utils.RSDebugger):
    """VTK content"""
...
@ipywidgets.register
class Viewer(ipywidgets.VBox, rs_utils.RSDebugger):
    ...
    def __init__(self, data=None):
        ...
        self.reset_btn = ipywidgets.Button(description='Reset Camera',
        ...
        self.orientation_toggle = ipywidgets.Checkbox(value=False, description='Show marker')
